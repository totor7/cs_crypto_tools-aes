...
void KeyGen ( uint8_t roundkeys [ ROUND_COUNT ][ STATE_ROW_SIZE ][ STATE_COL_SIZE ] , uint8_t master_key [
STATE_ROW_SIZE ][ STATE_COL_SIZE ]) ;
...
void GetRoundKey ( uint8_t roundkey [ STATE_ROW_SIZE ][ STATE_COL_SIZE ] , uint8_t roundkeys [ ROUND_COUNT ][
...
extern const uint8_t mixmatrix [4][4];
# endif